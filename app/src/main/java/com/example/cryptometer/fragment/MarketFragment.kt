...
import com.example.cryptometer.databinding.FragmentMarketBinding
...
class MarketFragment : Fragment() {
    ...
    private fun updateRecyclerView() {
        ...
        for(item in list){
            val coinName = item.name.toString().lowercase(Locale.getDefault())
            val coinSymbol = item.symbol.toString().lowercase(Locale.getDefault())
